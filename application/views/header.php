...
<head>
  ...
  <link href="<?php echo base_url() ?>assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">-->
    ...
    <link href="<?php echo base_url() ?>assets/css/responsive2.css" rel="stylesheet">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-10937349954"></script>
    <script>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-192985840-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
    ...
    <meta name="google-site-verification" content="SYuJ6IXEu7FxSWAH3MbCupb_y3RRFvDPqpCxEVtKHNk" />
    ...
    //   fbq('init', '1206575390145804');
    //   fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=1206575390145804&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
    <script>
    ...
    <div class="header-wrap">
        ...
        <header id="header" class="fixed-top">
            <div class="container-">
                <div class="container">
                    <a href="<?php echo base_url() ?>" class="logo mr-auto">
                        <img src="<?php echo base_url() ?>assets/images/logo-header.png" alt="Asia Hilux Logo">
                    </a>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-9">
                            <div class="header-content-left">
                                ...
                                <!--<p class="time"><b>Pakistan Time:</b> <?php echo date("h:i:sa d-m-Y"); ?></p>-->
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><b>Total Cars: <?php echo count($get_all_cars_count); ?></b></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><i class="fa fa-phone"> </i><a href="tel:+66633031732"> +66 6330 31732</a></p>
                                        <p><i class="fa fa-phone"> </i><a href="tel:+66633031735"> +66 6330 31735</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <ul>
                                                <b>Browse Stock:</b>
                                                <!--<li><a href="<?php echo base_url() ?>search">Browse All Cars</a></li>-->
                                                <li><a href="<?php echo base_url() ?>all-discounted">Discounted</a></li>
                                                <li><a href="<?php echo base_url() ?>all-clearance">Clearance</a></li>
                                        ...
                                        <ul class="col-md-3 col-sm-3">
                                            ...
                                            ?>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="<?php echo base_url() ?>brand/<?php echo $small; ?>"><?php echo $fac; ?>(<?php echo $row['make_count']; ?>)</a>
                                                </li>
                                            <?php } ?>
                                        ...
                                        <ul class="col-md-3 col-sm-3">
                                            ...
                                            ?>
                                                ...
                                                <li>
                                                    <a href="<?php echo base_url() ?>car-type/<?php echo $small_cbt; ?>"><?php echo $row['bodytype_name']; ?>(<?php echo $row['make_count']; ?>)</a>
                                                </li>
                                        ...
                                        <ul class="col-md-3 col-sm-3">
                                            ...
                                            <?php foreach ($get_make_count_country as $row) { ?>
                                                <li><a href="<?php echo base_url(); ?>country/<?php echo $row['country_name'] ?>"><?php echo $row['country_name']; ?>(<?php echo $row['country_count']; ?>)</a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li class="drop-down single-dropdown"><a href="#">Country</a>
                            <div class="mega-menu">
                                <ul>
                                    <?php foreach ($get_make_count_country as $row) { ?>
                                        <li><a href="<?php echo base_url(); ?>country/<?php echo $row['country_name'] ?>"><?php echo $row['country_name']; ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </li>
                        <li class="drop-down single-dropdown"><a href="#">Stock</a>
                            <div class="mega-menu">
                                <ul>
                                    <li><a href="<?php echo base_url() ?>brand/ford">Ford</a></li>
                                    <li><a href="<?php echo base_url() ?>model/revo">Revo</a></li>
                                    <li><a href="<?php echo base_url() ?>car-type/double-cab">Double Cab</a></li>
                                    <li><a href="<?php echo base_url() ?>car-type/standard-cab">Standard Cab</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="hd_class"><a href="<?php echo base_url() ?>why-choose-asia-hilux">Why Choose Asia Hilux?</a></li>
                        <li class="hd_class"><a href="<?php echo base_url() ?>how-to-buy">How to Buy</a></li>
            ...
            <div class="bot_head" style="display: none;">
                <ul>
                    <li><a href="<?php echo base_url() ?>why-choose-asia-hilux"><i class="icofont-hand-power"></i>  Why Choose..</a></li>
                    <li><a href="<?php echo base_url() ?>how-to-buy"><i class="icofont-ui-search"></i> How to Buy</a></li>
                    <li><a href="<?php echo base_url() ?>blog"><i class="icofont-blogger"></i>  Blog</a></li>
                </ul>
            </div>
        </header>
    </div>
