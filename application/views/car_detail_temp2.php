...
<div class="col-md-2 carleft-sidebar">
                <div class="list">
                    <div class="list-title" style="background-color:#2e3192 !important;">
                        <span>Recomended Cars</span>
                    </div>
                </div>
                <div class="row">
                    <?php
                    foreach ($getDiffCarModels as $side_car) {
                                ...
                                <div class="carousel-inner">
                                    ...
                                    foreach ($car_images as $img) {
                                        ...
                                        <div class="carousel-item <?php echo $class; ?>" data-slide-number="<?php echo $img['s_no']; ?>">
                                            ...
                                            <img src="<?php echo base_url(); ?>/uploads/<?php echo $imgs ?>" class="d-block w-100" alt="<?php echo $imgs ?>" data-remote="<?php echo base_url(); ?>/uploads/<?php echo $imgs ?>" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" />
                                        </div>
                                    <?php $no++;
                                    } ?>
                                </div>
                                            ...
                                            <td>
                                                <select name="country" class="form-control" id="country_list">
                                                    ...
                                                    <?php foreach ($countrys as $country) { ?>
                                                        <option value="<?php echo $country['hv_port_country_id'] ?>"><?php echo $country['country_name'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </td>
                                        </tr>
