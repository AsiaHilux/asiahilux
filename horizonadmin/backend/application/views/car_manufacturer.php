                ...
                <div class="row">
                    ...
                    <script type="text/javascript">
                        ...
                        function load_view($btn) {
                                //
                                $("#page_content").load
                                ("<?= base_url() . 'index.php/'; ?>car_manufacturer/load_view/", function (responseTxt, statusTxt, xhr) {
                        ...
                        function load_from($btn) {
                                //
                                $("#page_content").load("<?= base_url() . 'index.php/'; ?>car_manufacturer/load_new/", function (responseTxt, statusTxt, xhr) {
