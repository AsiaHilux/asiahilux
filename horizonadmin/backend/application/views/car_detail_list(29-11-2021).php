<div class="row">
    <div class="col-md-12">
    	<div class="card card-underline">
    		<div class="card-head">
    			<header><h4>View Car Details</h4></header>
    		</div><!--end .card-head -->
    		<div class="card-body">
                ...
                <table id="example3" class="table table-hover">
					<thead>
						<tr>
							...
							<th style="width: 10%;">Sys generat no.</th>
        ...
        $.each(result, function(i, field){
            ...
            if(field.length == 0) {
                ...
                for(j=0; j<field.length;j++)
                {
                    ...
                    rowtags += '<tr><td>' + sn + '</td><td style="width: 5%;">' + ((field[j].stored_file_name != null) ? '<img  style="cursor: pointer; border: 2px solid #9a9a9a;" class="img-circle width-1 showpic" src="../../../../uploads/' + field[j].stored_file_name +'" /> ' :'' + '<img style="cursor: pointer; border: 2px solid #9a9a9a;" class="img-circle width-1 showpic" src="../../../../uploads/car_avatar_no_image.png' +'" /> ' ) + '</td><td style="width: 10%;">' + field[j].acc_no + '</td><td style="width: 15%;">' + field[j].vm_name + '</td><td style="width: 20%;">' + ((field[j].model_name != null) ? field[j].model_name :'' + " -- " ) + '</td><td style="width: 20%;">' + field[j].carname + '</td><td style="width: 10%;">' + "$ " + field[j].carprice + '</td><td style="display: none;">' + ((field[j].CDPlayer == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].LeatherSeat == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].AlloyWheels == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' +  ((field[j].PowerSteering == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].PowerWindow == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].AC == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].ABS == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].Airbag == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].Radio == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].CDChanger == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].DVD == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].TV == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].PoweSeat == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].BackTire == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].GrillGuard == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].RearSpoiler == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].CentralLocking == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].Jack == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].SpareTire == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + ((field[j].WheelSpanner == 1) ? 'Yes' : 'No') + '</td><td style="display: none;">' + field[j].VehicleNo + '</td><td style="display: none;">' + field[j].Chassis + '</td><td style="display: none;">' + field[j].ModelCode + '</td><td style="display: none;">' + field[j].VersionClass + '</td><td style="display: none;">' + field[j].EngineCode + '</td><td style="display: none;">' + field[j].Mileage + '</td><td style="display: none;">' + field[j].EngineSize + '</td><td style="display: none;">' + field[j].RegistrationYear + '</td><td style="display: none;">' + field[j].RegistrationMonth + '</td><td style="display: none;">' + field[j].ManufactureYear + '</td><td style="display: none;">' + field[j].ManufactureMonth + '</td><td style="display: none;">' + field[j].Ext_Color + '</td><td style="display: none;">' + field[j].WheelDrive + '</td><td style="display: none;">' + field[j].Location + '</td><td style="display: none;">' + field[j].Dimension + '</td><td style="display: none;">' + field[j].Doors + '</td><td style="display: none;">' + field[j].M3 + '</td><td style="display: none;">' + field[j].Seats + '</td><td style="display: none;">' + field[j].Weight + '</td><td style="width: 20%; text-align:center;"><button id="btn_upload_pic" data="' + field[j].car_d_id + '" class="btn btn-xs btn-primary btn-responsive glyphicon glyphicon-upload" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Upload Car Featured Image"></button>&nbsp;&nbsp;<button name="btn_view" data="' + field[j].car_d_id + '" class="btn btn-xs btn-primary btn-responsive  glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="More Detail"></button>&nbsp;&nbsp;<button name="btn_edit" data="' + field[j].car_d_id + '" class="btn btn-xs btn-primary btn-responsive glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Edit"></button>&nbsp;&nbsp;<button name="btn_delete" data="' + field[j].car_d_id + '" class="btn btn-xs btn-danger btn-responsive glyphicon glyphicon-remove " data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Delete"></button></td></tr>';;
                    sn += 1;
                }
...
$("#page_links").on("click", ".pagination a", function(){
    ...
    $('#example3').on('click', 'button[name=btn_edit]', function()
    {
        ...
        $("#page_content").load
        ("<?= base_url() . 'index.php/'; ?>car_detail/load_edit?car_d_id="+car_d_id, function(responseTxt, statusTxt, xhr){
                    ...
                    xhr: function(){
                        ...
                        xhr.upload.addEventListener("progress", function(event){
                            if(event.lengthComputable){
                                ...
                                $("#pregressbar").css({width: percentComplete+"%"});
