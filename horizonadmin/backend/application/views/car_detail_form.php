...
if (isset($formdata)) {
    ...
    $car_d_id = $formdata[0]['car_d_id'];
    $acc_no = $formdata[0]['acc_no'];
   
   
    $carname = $formdata[0]['carname'];
    $CDPlayer = $formdata[0]['CDPlayer'];
    $SunRoof = $formdata[0]['SunRoof'];
    $LeatherSeat = $formdata[0]['LeatherSeat'];
    $AlloyWheels = $formdata[0]['AlloyWheels'];
    $PowerSteering = $formdata[0]['PowerSteering'];
    $PowerWindow = $formdata[0]['PowerWindow'];
    $AC = $formdata[0]['AC'];
    $ABS = $formdata[0]['ABS'];
    $Airbag = $formdata[0]['Airbag'];
    $Radio = $formdata[0]['Radio'];
    $CDChanger = $formdata[0]['CDChanger'];
    $DVD = $formdata[0]['DVD'];
    $TV = $formdata[0]['TV'];
    $PoweSeat = $formdata[0]['PoweSeat'];
    $BackTire = $formdata[0]['BackTire'];
    $GrillGuard = $formdata[0]['GrillGuard'];
    $RearSpoiler = $formdata[0]['RearSpoiler'];
    $CentralLocking = $formdata[0]['CentralLocking'];
    $Jack = $formdata[0]['Jack'];
    $SpareTire = $formdata[0]['SpareTire'];
    $WheelSpanner = $formdata[0]['WheelSpanner'];

    $carprice = $formdata[0]['carprice'];
    $Bodytype = $formdata[0]['bodytype_id'];
    $Fuel = $formdata[0]['Fuel'];
    $Transmission = $formdata[0]['Transmission'];
    $Steering = $formdata[0]['Steering'];
    

    $VehicleNo = $formdata[0]['VehicleNo'];
    $Chassis = $formdata[0]['Chassis'];
    $ModelCode = $formdata[0]['ModelCode'];
    $VersionClass = $formdata[0]['VersionClass'];
    $EngineCode = $formdata[0]['EngineCode'];
    $Mileage = $formdata[0]['Mileage'];
    $EngineSize = $formdata[0]['EngineSize'];
    $RegistrationYear = $formdata[0]['RegistrationYear'];
    $RegistrationMonth = $formdata[0]['RegistrationMonth'];
    $ManufactureYear = $formdata[0]['ManufactureYear'];
    $ManufactureMonth = $formdata[0]['ManufactureMonth'];
    $Ext_Color = $formdata[0]['Ext_Color'];
    $WheelDrive = $formdata[0]['WheelDrive'];
    $Location = $formdata[0]['Location'];
    $Dimension = $formdata[0]['Dimension'];
    $Doors = $formdata[0]['Doors'];
    $M3 = $formdata[0]['M3'];
    $Seats = $formdata[0]['Seats'];
    $Weight = $formdata[0]['Weight'];
    $Country = $formdata[0]['country_detail_id'];
    $car_tag = $formdata[0]['car_tag'];
    $cardisprice = $formdata[0]['cardisprice'];
    ...
    $entry_name = $temp_form_data['entry_name'];
    $tag = "";
    
    $car_d_id = $temp_form_data['car_d_id'];
    $acc_no = $temp_form_data['acc_no'];
    $vm_id = "";
    $m_id = "";
        ...
        <div class="card panel card-underline">
            <div class="card-head">
                <header><h3><?php
                        if ($tag == "Edit")
                            ...
                            echo "Add New Car Details"; ?></h3></header>
            ...
            <div>
                ...
                <form id="myform" class="form form-validate">
                    ...
                    <input type="hidden" id="entry_name" name="entry_name" value="<?= $entry_name; ?>" />
                    <input type="hidden" id="car_d_id" name="car_d_id" value="<?= $car_d_id; ?>" />
                        
                        <div class="row">

                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="acc_no" name="acc_no" disabled="ture" value="<?= $acc_no ?>"
                                                           data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="This is system auto-generated car number and not editable.">           
                                        <label for="acc_no">
                                        System auto generated no. for car 
                                        </label>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="carname" name="carname" maxlength="300" 
                                           data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 300 characters allowed"
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="CDPlayer"
                                           name="CDPlayer" <?php if ($CDPlayer == "1") echo "checked"; else echo ""; ?>><span>CD Player</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="SunRoof"
                                           name="SunRoof" <?php if ($SunRoof == "1") echo "checked"; else echo ""; ?>><span>Sun Roof</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="LeatherSeat"
                                           name="LeatherSeat" <?php if ($LeatherSeat == "1") echo "checked"; else echo ""; ?>><span>Leather Seat</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="AlloyWheels"
                                           name="AlloyWheels" <?php if ($AlloyWheels == "1") echo "checked"; else echo ""; ?>><span>Alloy Wheels</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="PowerSteering"
                                           name="PowerSteering" <?php if ($PowerSteering == "1") echo "checked"; else echo ""; ?>><span>Power Steering</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="PowerWindow"
                                           name="PowerWindow" <?php if ($PowerWindow == "1") echo "checked"; else echo ""; ?>><span>Power Window</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="AC"
                                           name="AC" <?php if ($AC == "1") echo "checked"; else echo ""; ?>><span>A/C</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="ABS"
                                           name="ABS" <?php if ($ABS == "1") echo "checked"; else echo ""; ?>><span>ABS</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="Airbag"
                                           name="Airbag" <?php if ($Airbag == "1") echo "checked"; else echo ""; ?>><span>Airbag</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="Radio"
                                           name="Radio" <?php if ($Radio == "1") echo "checked"; else echo ""; ?>><span>Radio</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="CDChanger"
                                           name="CDChanger" <?php if ($CDChanger == "1") echo "checked"; else echo ""; ?>><span>CD Changer</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="DVD"
                                           name="DVD" <?php if ($DVD == "1") echo "checked"; else echo ""; ?>><span>DVD</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="TV"
                                           name="TV" <?php if ($TV == "1") echo "checked"; else echo ""; ?>><span>TV</span>
                                </label>
                            </div>

                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="PoweSeat"
                                           name="PoweSeat" <?php if ($PoweSeat == "1") echo "checked"; else echo ""; ?>><span>Power Seat</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="BackTire"
                                           name="BackTire" <?php if ($BackTire == "1") echo "checked"; else echo ""; ?>><span>Back Tire</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="GrillGuard"
                                           name="GrillGuard" <?php if ($GrillGuard == "1") echo "checked"; else echo ""; ?>><span>Grill Guard</span>
                                </label>
                            </div>

                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="RearSpoiler"
                                           name="RearSpoiler" <?php if ($RearSpoiler == "1") echo "checked"; else echo ""; ?>><span>Rear Spoiler</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="CentralLocking"
                                           name="CentralLocking" <?php if ($CentralLocking == "1") echo "checked"; else echo ""; ?>><span>Central Locking</span>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="Jack"
                                           name="Jack" <?php if ($Jack == "1") echo "checked"; else echo ""; ?>><span>Jack</span>
                                </label>
                            </div>

                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="SpareTire"
                                           name="SpareTire" <?php if ($SpareTire == "1") echo "checked"; else echo ""; ?>><span>Spare Tire</span>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="checkbox-inline checkbox-styled checkbox-success">
                                    <input type="checkbox" id="WheelSpanner"
                                           name="WheelSpanner" <?php if ($WheelSpanner == "1") echo "checked"; else echo ""; ?>><span>Wheel Spanner</span>
                                </label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="carprice" name="carprice" max="99999" 
                                           data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 5 digit allowed Format Price is : $65000"
                                           value="<?= $carprice; ?>" required="true">
                                    <label for="Car Price">
                                        Car Price *
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    max="99999999999" data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 11 digit allowed Format Vehicle No. is : 725040"
                                           value="<?= $VehicleNo; ?>" required="true" >
                                    <label for="VehicleNo">
                                        Vehicle No. *
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="Chassis" name="Chassis" maxlength="100" data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 100 characters are allowed"
                                           value="<?= $Chassis; ?>">
                                    <label for="Chassis">
                                        Chassis # 
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="VersionClass" name="VersionClass" maxlength="200" data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 200 characters are allowed"
                                           value="<?= $VersionClass; ?>">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="EngineCode" name="EngineCode"
                                    maxlength="100" data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 100 characters are allowed"
                                           value="<?= $EngineCode; ?>">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="EngineSize" name="EngineSize"
                                           maxlength="10" data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 10 characters are allowed"
                                           value="<?= $EngineSize; ?>">
  ...
  <div class="form-group">
          <select id="ManufactureMonth" name="ManufactureMonth" class="form-control select2-list" required="true">
            ...
            <label for="ManufactureMonth">Manufacture Month *</label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="Ext_Color" name="Ext_Color" maxlength="100" 
                                           data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="WheelDrive" name="WheelDrive" maxlength="20" 
                                           data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 20 characters allowed" value="<?= $WheelDrive; ?>">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="Dimension" name="Dimension" maxlength="100" 
                                           data-toggle="Dimension" data-placement="Dimension"
                                           data-trigger="hover"
                                           data-original-title="Maximum 100 characters allowed"
                                           value="<?= $Dimension; ?>">
                            <label for="Dimension">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="number" class="form-control" id="Doors" name="Doors" max="30" data-toggle="tooltip" data-placement="bottom"
data-trigger="hover" data-original-title="Maximum 3 digit allowed. Format Doors is : 3, 5 etc"
value="<?= $Doors; ?>">
                            <label for="Doors">
                               Doors
                            </label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="M3" name="M3" maxlength="100" data-toggle="tooltip" data-placement="bottom"
data-trigger="hover" data-original-title="Maximum 10 digit allowed Format M3 is : 7.624"
value="<?= $M3; ?>">
                            <label for="M3">
                                M3 
                            </label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="number" class="form-control" id="Seats" name="Seats" max="200" data-toggle="tooltip" data-placement="bottom"
data-trigger="hover" data-original-title="Maximum 3 digit allowed. Format Seats is : 2 , 5 etc"
value="<?= $Seats; ?>">
                            <label for="Seats">
                               Seats
                            </label>
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="Weight" name="Weight" maxlength="20" data-toggle="tooltip" data-placement="bottom"
                                    data-trigger="hover"
                                    data-original-title="Maximum 20 characters are allowed. Format Seats is : 740 etc"
                                    value="<?= $Weight; ?>">
                                    <label for="Weight">
                                       Weight
                                    </label>
                        ...
                        <option value="2" <?php if( $car_tag == "2" ) echo 'selected="selected"'; ?>>Clearance Sale</option>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="cardisprice" name="cardisprice" max="99999" 
                                           data-toggle="tooltip" data-placement="bottom"
                                           data-trigger="hover"
                                           data-original-title="Maximum 5 digit allowed Format Price is : $65000"
                                           value="<?= $cardisprice; ?>">
    ...
    function save_car_details(button_name)
{
    ...
    var res = form.valid();
        ...
        {
           url = "<?= base_url() . 'index.php/'; ?>car_detail/update";
        }
        ///////
        ...
        SendDataByAjax3(
            ...
            function(result)
            {
                ...
                if( result_array.res )
                {
                    ...
                    if(button_name == "btn_save_and_new")
                    {
