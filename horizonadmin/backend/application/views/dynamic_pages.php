                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="card" style="margin-bottom: -3px;">
                                <div class="card-head">
                                    <header><h3>Dynamic Pages Name</h3></header>
                                    <div class="tools">
                                        <div class="btn-group">
                    ...
                    <script type="text/javascript">
                        ...
                        function load_view($btn) {
                                ...
                                $("#page_content").load
                                ("<?= base_url() . 'index.php/'; ?>dynamic_pages/load_view/", function (responseTxt, statusTxt, xhr) {
                        ...
                        function load_from($btn) {
                                ...
                                $("#page_content").load("<?= base_url() . 'index.php/'; ?>dynamic_pages/load_new/", function (responseTxt, statusTxt, xhr) {
