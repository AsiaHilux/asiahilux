<div class="row">
    <div class="col-md-12">
        <div class="card card-underline">
            <div class="card-head">
                <header><h4>View  Dynamic Pages Name</h4></header>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="example3" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th>How TO Buy Content</th>
                            <th>Bank Details Content</th>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete  Dynamic Pages Name</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="dp_id_del" value="" class="form-control"
                               placeholder="dp_id_del" required>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var url = "<?= base_url() . 'index.php/'; ?>dynamic_pages/select";

        $("#search").keyup(function () {
            var value = this.value.toLowerCase().trim();
            var url = "<?= base_url() . 'index.php/'; ?>dynamic_pages/select?search_term="+value;
                    ...
                    if (i == "dynamicpages") {
                        ...
                        if (field.length == 0) {
                            ...
                            for (j = 0; j < field.length; j++) {
                                ...
                                rowtags += '<tr><td>' + sn + '</td><td>' + field[j].dp_content_about_us + '</td><td>' + field[j].dp_content_terms_conditions + '</td><td>' + field[j].dp_content_privacy_policy + '</td><td style="text-align:center;"><button name="btn_edit" data="' + field[j].dp_id + '" class="btn btn-primary glyphicon btn-responsive glyphicon-edit margin-2px"></button>&nbsp;&nbsp;<button name="btn_delete" data="' + field[j].dp_id + '" class="btn btn-danger btn-responsive glyphicon glyphicon-remove"></button></td></tr>';
                                sn += 1;
                            }
        ...
        $('#example3').on('click', 'button[name=btn_edit]', function () {
            ...
            $("#page_content").load
            ("<?= base_url() . 'index.php/'; ?>dynamic_pages/load_edit?id=" + id, function (responseTxt, statusTxt, xhr) {
        ...
        $("#btn_delete").click(function () {
            if ($('#flag_del').val() == "Delete") {
                ...
                url = "<?= base_url() . 'index.php/'; ?>dynamic_pages/delete";
