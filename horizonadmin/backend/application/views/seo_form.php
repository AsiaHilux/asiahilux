            ...
            <div class="card card-underline">
                <div class="card-head">
                    ...
                    if($tag=="Edit") 
                        ...
                        echo "Add New Seo Tags"; ?></h4></header>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form id="myform" class="form form-validate">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" id="hv_seo_id"
                                               name="hv_seo_id" value="<?= $id ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea class="form-control" id="home_page_content" name="home_page_content" maxlength="60000" data-toggle="tooltip" data-placement="bottom"
                                    data-trigger="hover"
                                    data-original-title="Maximum 60,000 characters are allowed." rows="5"><?= $home_page_content; ?></textarea>
...
<script type="text/javascript">
                        ...
                        $("#btn_save").click(function () {
                            ...
                            if (res) {
                                ...
                                var formdata = {
                                    'hv_seo_id': $("#hv_seo_id").val(),
                                    'Title': $("#Title").val(),
                                    'Keywords': $("#Keywords").val(),
                                    'Description': $("#Description").val(),
                                    'home_page_content': $("#home_page_content").val(),
                                    'active': status
                                }
                                if ($('#flag').val() == "") {
                                    url = "<?= base_url() . 'index.php/'; ?>seo/create";
                                    
                                }
                                else if ($('#flag').val() == "Edit") {
                                    url = "<?= base_url() . 'index.php/'; ?>seo/update";
