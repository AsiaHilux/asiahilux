                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="card" style="margin-bottom: -3px;">
                                <div class="card-head">
                                    <header><h3>Car Body Type Names</h3></header>
                                    <div class="tools">
                                        <div class="btn-group">
                    ...
                    <script type="text/javascript">
                        ...
                        function load_view($btn) {
                                //
                                $("#page_content").load
                                ("<?= base_url() . 'index.php/'; ?>car_body_type/load_view/", function (responseTxt, statusTxt, xhr) {
                        ...
                        function load_from($btn) {
                                //
                                $("#page_content").load("<?= base_url() . 'index.php/'; ?>car_body_type/load_new/", function (responseTxt, statusTxt, xhr) {
