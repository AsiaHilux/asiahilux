<div class="row">
    <div class="col-md-12">
        <div class="card card-underline">
            <div class="card-head">
                <header><h4>View  Car Body Type Names</h4></header>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete  Car Body Type Name</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="bodytype_id_del" value="" class="form-control"
                               placeholder="bodytype_id_del" required>
                    </div>
...
<!-- End file upload modal -->
    ...
    <script type="text/javascript">
        ...
        var url = "<?= base_url() . 'index.php/'; ?>car_body_type/select";

        $("#search").keyup(function () {
            var value = this.value.toLowerCase().trim();
            var url = "<?= base_url() . 'index.php/'; ?>car_body_type/select?search_term="+value;
                    ...
                    if (i == "deptype") {
                        ...
                        if (field.length == 0) {
                            ...
                            for (j = 0; j < field.length; j++) {
                                ...
                                rowtags += '<tr><td>' + sn + '</td><td>' + field[j].bodytype_name + '</td><td style="text-align:center;"><span class="' + status + '"></span></td><td style="text-align:center;"><button name="btn_edit" data="' + field[j].bodytype_id + '" class="btn btn-primary glyphicon btn-responsive glyphicon-edit margin-2px"></button>&nbsp;&nbsp;<button name="btn_delete" data="' + field[j].bodytype_id + '" class="btn btn-danger btn-responsive glyphicon glyphicon-remove"></button></td></tr>';
                                sn += 1;
                            }
        ...
        $('#example3').on('click', 'button[name=btn_edit]', function () {
            ...
            $("#page_content").load
            ("<?= base_url() . 'index.php/'; ?>car_body_type/load_edit?id=" + id, function (responseTxt, statusTxt, xhr) {
        ...
        $("#btn_delete").click(function () {
            if ($('#flag_del').val() == "Delete") {
                var formdata_d =
                    {
                        'bodytype_id': $("#bodytype_id_del").val()
                    }
                url = "<?= base_url() . 'index.php/'; ?>car_body_type/delete";
...
$("#btn_upload").click(function(){
    ...
    var upload_url = "<?= base_url() . 'index.php/'; ?>car_body_type/upload_attachment_for_featured_Image";
    
    var file_to_upload = input_file[0].files[0]; 
    
    var server_response = [];
    var url = "<?= base_url() . 'index.php/'; ?>car_body_type/validate_upload_attanchment?file_name="+file_to_upload.name+"&file_size="+file_to_upload.size;
    $.getJSON(url, function(result){
        ////////////////////////////////////////////////////
